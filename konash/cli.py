...
def main(argv: list[str] | None = None) -> None:
    ...
    p_train.add_argument("--api-base", default=None, help="LLM API base URL.")
    p_train.add_argument("--api-key", default=None, help="LLM API key.")
    ...
    p_solve.add_argument("--api-base", default=None, help="LLM API base URL.")
    p_solve.add_argument("--api-key", default=None, help="LLM API key.")
