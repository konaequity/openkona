...
class QuestionAnswerSynthesizer:
    ...
    def _system_prompt(self) -> str:
        ...
        return (
            ...
            "- Combines 2+ specific facts from the corpus\n"
            "- Has a specific, verifiable answer found in the documents\n"
            "- Requires connecting information across different passages\n"
            "- Example: 'What ancient construction material, used in a structure "
            "completed in 80 AD, relied on volcanic ash and had a property not "
            ...
            "- Vague or has multiple valid answers\n\n"
            "FORMAT — one per turn:\n"
